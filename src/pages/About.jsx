...
<div className="App">
   <div class=" h-screen backdrop-blur-3xl flex flex-col pt-7 ">
   ...
   <div class="items-center max-w-screen-xl px-8  py-8 mx-auto lg:grid grid-cols-4 lg:gap-16 xl:gap-24 lg:py-24 lg:px-6 flex-col md:flex-row">
    <div class="col-span-2 mb-8">
        ...
        <div class="pt-6 mt-6 space-y-4 border-t border-gray-200 dark:border-gray-700">
            <div  >
                <a href="/Amit Ram.pdf"
                    class="inline-flex items-center text-4xl font-medium text-purple-500 hover:text-purple-800 dark:text-purple-500 dark:hover:text-purple-700">
                    Resume
