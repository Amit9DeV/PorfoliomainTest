  ...
  return (
    <div className="min-h-screen py-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="fixed inset-0 -z-10">
        ...
        <div className="absolute bottom-1/3 right-1/3 w-64 h-64 bg-blue-500/5 rounded-full filter blur-3xl" />
          ...
          <div className="md:col-span-2">
            ...
            >
              ...
              >
                ...
                {/* Contact Form */}
                {showContactForm && (
                  <div className="mt-4 p-4 border border-blue-500/30 rounded-md bg-black/30 backdrop-blur-md">
