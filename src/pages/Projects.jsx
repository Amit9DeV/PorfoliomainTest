...
const Projects = () => {
  ...
  return (
    <div className="App bg-transparent ">
      ...
      <div
        className="animateSection2 flex-col text-white bg-black "
        style={{
          height: "100vh",
          display: "flex",
          alignItems: "center",
      ...
      >
        <TooltipProvider>
          <Tooltip>
            ...
            <TooltipContent>
              <span class=" cursor-move py-2 px-14 transition-all ease-in duration-75 bg-black   rounded-md group-hover:bg-opacity-0">
                <a href="https://nex-cart-test.vercel.app/">Preview</a>
              </span>
            </TooltipContent>
          </Tooltip>
        </TooltipProvider>
        ...
        <div className="flex items-center justify-center p-5 border-b">
          ...
          <i className="flex flex-col items-center justify-center p-5">
            <SiExpress className="text-yellow-600" />
            <span>Express JS</span>
          </i>
          <i className="flex flex-col items-center justify-center p-5">
            {" "}
            <img className="w-20" src="/MongoDB_Fores-Green.svg" alt="" />{" "}
            <span>MongoDB</span>
          </i>
        </div>
      </div>
      ...
      >
        <TooltipProvider>
          <Tooltip>
            ...
            <TooltipContent>
              <span class=" cursor-move py-2 px-14 transition-all ease-in duration-75 bg-black   rounded-md group-hover:bg-opacity-0">
                <a href="https://librarymanagementbyamit.netlify.app/">Preview</a>
              </span>
            </TooltipContent>
          </Tooltip>
        </TooltipProvider>
      ...
      >
        <h2 className="text-6xl text-white">
          More Projects Coming with MERN DEV{" "}
        </h2>
      </div>
    </div>
  );
